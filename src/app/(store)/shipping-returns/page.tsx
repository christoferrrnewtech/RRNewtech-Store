    ...
    <Container className="max-w-3xl py-12">
      ...
      <div className="mt-8 space-y-8 text-base leading-relaxed text-muted">
        <section>
          ...
          <p className="mt-2">
            We deliver to clinics and homes across the Philippines, with tracking on every order.
            Delivery typically takes 2–5 business days for Metro Manila and 3–7 business days for
            provincial addresses, depending on the location.
          </p>
        </section>
        <section>
          <h2 className="text-lg font-bold text-fg">Shipping fees</h2>
          <p className="mt-2">
            Delivery is a flat {formatPHP(FLAT_SHIPPING_FEE)} nationwide, shown on your order
            summary before you pay. Orders over {formatPHP(FREE_SHIPPING_THRESHOLD)} ship free. Bulk
            or oversized equipment orders may be quoted separately — our team will confirm before
            dispatch.
          </p>
        </section>
        <section>
