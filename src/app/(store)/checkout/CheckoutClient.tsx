...
export function CheckoutClient({
  ...
  // then switching the province to Davao would post "Cebu City, Davao" — an address that looks
  // well-formed and cannot be delivered.
            ...
            <section>
              ...
              <div className="mt-3 flex flex-col gap-3">
                ...
                {/* Broadest first, narrowing down to the street. The three location fields are
                    dropdowns fed by the committed PSGC snapshot, so a picked address is a real
                    one rather than a typo. Each cascades: choosing a province loads its cities,
                    choosing a city loads its barangays. */}
              ...
              <p className="mt-3 text-xs leading-relaxed text-muted-light">
                {paymentsEnabled ? (
                  <>
                    ...
                    payment. Shipping is a flat {formatPHP(FLAT_SHIPPING_FEE)}, free on orders over{" "}
