...
export type Order = {
  ...
  /**
   * What delivery cost on this order — a SNAPSHOT from `quoteShipping()` at the moment of
   * ordering, never recomputed. The flat rate will change; an old order must keep what it charged.
   */
  shippingFee: number;
